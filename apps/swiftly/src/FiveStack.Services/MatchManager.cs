...
public class MatchManager
{
    ...
    private CancellationTokenSource? _pendingPauseRetryTimer;
    ...
    public AutoCancelCountdownSystem autoCancelCountdownSystem => _autoCancelCountdownSystem;
    ...
    public void PauseMatch(string? message = null, bool skipUpdate = false)
    {
        if (_timeoutSystem.IsTimeoutActive())
        {
            ...
            TimerUtility.Kill(_pendingPauseRetryTimer);
    ...
    public List<MatchMember> GetLineupPlayersForTeam(Team team)
    {
        MatchData? matchData = GetMatchData();
        MatchMap? currentMap = GetCurrentMap();
